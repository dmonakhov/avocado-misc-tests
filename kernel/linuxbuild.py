...
class LinuxBase(Test):
    ...
    def do_config(self):
        ...
        # Read dynamic config
        self.config_file = os.path.join(data_dir.get_tmp_dir(), "dynconfig.json")
        self.config = {}
...
class Linux01Download(LinuxBase):
    ...
    def test(self):
        ...
        linux_archive = os.path.join(data_dir.get_tmp_dir(), bname)
        ...
        pq_archive = os.path.join(data_dir.get_tmp_dir(), 'linux-patch-queue.tar.gz')
